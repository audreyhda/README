...
SwiftUI · ObservableObject · Swift Charts · OOP (classes, structs, protocols) · DocC documentation · CBLD framework

---

### 🎓 [CS50x](https://github.com/audreyhda/CS50x) &nbsp;·&nbsp; *Harvard University*
> My solutions to every problem set, lab, and final project from CS50x.
...
MVVM · OOP · SOLID · REST · DocC

**Backend & Databases**

![MySQL](https://img.shields.io/badge/MySQL-4479A1?style=flat&logo=mysql&logoColor=white)
![SQLite](https://img.shields.io/badge/SQLite-003B57?style=flat&logo=sqlite&logoColor=white)
JWT · Fluent ORM · bcrypt
...
🎓 **Apple Foundation Program Advanced** — Simplon Paris *(2024)*
Full-stack iOS development programme: 6 consecutive challenges covering SwiftUI, UIKit, OOP, SOLID principles, REST APIs with Vapor, MySQL, UML, Merise, AGILE, and CBLD framework.

🎓 **CS50x** — Harvard University *(ongoing)*
